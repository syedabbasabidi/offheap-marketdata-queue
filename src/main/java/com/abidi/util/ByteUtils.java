...
public class ByteUtils {
    ...
    private  ByteBuffer securityBuffer = ByteBuffer.allocate(12);
    private  ByteBuffer brokerBuffer = ByteBuffer.allocate(3);
    private  ByteBuffer dateBuffer = ByteBuffer.allocate(19);
    ...
    public  long bytesToLong(byte[] bytes, int from, int length) {
